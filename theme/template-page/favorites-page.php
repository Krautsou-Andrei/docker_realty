...
<main class="page">
    <div class="main-favorites">
        ...
        $countPosts = !empty($postIds) ? $query->post_count : 0;
                    ...
                    foreach ($searchApart as $apart){ 
                    	...
                    	$imgpath1='';$imgpath2='';$imgpath3='';$imgpath4=''; $imgpath5='';
                          if($author['PICTURES']!='')
                          {
                    	        ...
                    	        $imgpath1=$scriptpath.'img/nofoto.jpg'; $imgpath2=''; $imgpath3=''; $imgpath4=''; $imgpath5='';
                          }
                            	    ...
                            	    <article class="product-card" >
                                        ...
                                        echo'   </div>
                                            ...
                                            <div class="card-preview__order order-agent">
                                                ...
                                                $now = new DateTime();$ref = new DateTime($author['DATECOR']);$diff = $now->diff($ref);
